...
function App() {
  ...
  const selectedGig =
    ...
    gigs.find(g => g.id === selectedGigId) || gigs[0];

  const stats = useMemo(() => {

    const total = gigs.reduce(

      (sum, g) => sum + Number(g.paid || 0),
    ...
    const outstanding = gigs.reduce(
      ...
      (sum, g) =>
        ...
        Math.max(
          ...
          Number(g.fee || 0) - Number(g.paid || 0),
  ...
  async function addGig(e) {
    ...
    const newGig = {
      ...
      invoice_status:
        ...
        Number(form.paid || 0) >= Number(form.fee || 0)
...
This agreement is between ${
    ...
    } and the Performer for the event "${
...
Balance Due: ${currency(
      ...
      Math.max(
        ...
        Number(g.fee || 0) - Number(g.deposit || 0),
      ...
      <header className="hero">
        ...
        <div>
          ...
          <p className="eyebrow">
            ...
            SOLO MUSICIAN BUSINESS MANAGER
          ...
          <p>
            ...
            Track bookings, invoices, income,

            contracts, and practice reminders in
